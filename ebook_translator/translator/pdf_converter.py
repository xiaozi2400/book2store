...
class PDFConverter:
    ...
    def _build_professional_cmd(self, epub_path, pdf_path, is_bilingual=False):
        ...
        _hf_cfg = self.config["header_footer"]
        ...
        cmd.extend(
            [
                ...
                page_cfg["paper_size"],
                "--margin-top",
                str(page_cfg["margin_top"]),
                "--margin-bottom",
                str(page_cfg["margin_bottom"]),
                "--margin-left",
                str(page_cfg["margin_left"]),
                "--margin-right",
                str(page_cfg["margin_right"]),
            ]
        )
        ...
        cmd.extend(
            [
                "--minimum-line-height",
                str(typo_cfg["minimum_line_height"]),
            ]
        )
